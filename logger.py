...
def show_message(log):
    ...
    print(message['head'])
    print(message['total']['info'], log['total'], message['total']['unit'])
    print(message['continuous']['info'], log['continuous'], message['continuous']['unit'])
    print(message['today']['info'], log['today'], message['today']['unit'])
    print(message['foot'])
